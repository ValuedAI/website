  ...
  return (
    <>
      ...
      <section className="section section-stats">
        <div className="container">
          <div className="stats-grid">
            <div className="stat-card"><div className="stat-number">2x</div><div className="stat-label">Revenue Impact</div><p className="stat-desc">Teams close more deals when operational bottlenecks stop slowing them down.</p></div>
        ...
        <div className="container">
          ...
          <div className="carousel-wrapper">
            <div className="carousel-track" id="carouselTrack">
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div><h4>Communication Intelligence</h4><p>Parse emails, messages, and requests to extract actionable operational context automatically.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2"/><rect x="8" y="2" width="8" height="4" rx="1"/></svg></div><h4>Task &amp; Ownership Tracking</h4><p>Assign tasks, track ownership, and maintain accountability across teams and workflows.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div><h4>Workflow Automation</h4><p>Automate multi-step processes from intake to resolution without custom engineering.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h4>Status Visibility</h4><p>Real-time operational visibility across all active workflows, tasks, and pending actions.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg></div><h4>Exception Detection</h4><p>Identify delays, blockers, and anomalies before they cascade into bigger operational issues.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="3"/><path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"/></svg></div><h4>Cross-System Coordination</h4><p>Connect actions across email, ERP, spreadsheets, and messaging into one operational thread.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg></div><h4>Approval Routing</h4><p>Route approvals to the right people, track responses, and escalate when things stall.</p></div>
              <div className="cap-card"><div className="cap-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></div><h4>Follow-Up Generation</h4><p>Automatically draft and schedule follow-ups based on workflow context and deadlines.</p></div>
            </div>
            <div className="carousel-controls">
              <button className="carousel-btn carousel-prev" id="carouselPrev" aria-label="Previous"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="15 18 9 12 15 6"/></svg></button>
              <div className="carousel-dots" id="carouselDots"></div>
              <button className="carousel-btn carousel-next" id="carouselNext" aria-label="Next"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6"/></svg></button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section-light" id="integrations">
        <div className="container">
          <div className="section-header"><h2>Works with your existing tools — not against them</h2><p className="section-sub">No rip-and-replace. Klova connects to the systems you already use and starts adding value from day one.</p></div>
      ...
      <section className="section section-dark" id="why-us">
        <div className="container">
          <div className="section-header"><h2>Why teams choose Klova</h2></div>
      ...
      <section className="section section-light">
        <div className="container">
          <div className="section-header"><h2>Built to earn your team&apos;s trust</h2><p className="section-sub">Whether you&apos;re exploring AI for the first time or scaling what already works, Klova is designed to fit into real business environments.</p></div>
          <div className="trust-grid">
            <div className="trust-item"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg><span>Flexible deployment options</span></div>
            <div className="trust-item"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg><span>Integration-friendly architecture</span></div>
            <div className="trust-item"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg><span>Role-based controls</span></div>
            <div className="trust-item"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg><span>Built for operational reliability</span></div>
          </div>
        </div>
      </section>
